var FisCal = (function FisCal(){
    ...
    var page = {
        startTime: arr("input[id$=st].text.dr-time")[0],
        endTime: arr("input[id$=et].text.dr-time")[0],
        guests: arr("div[id$=guests].ep-dp-guests div.ep-gl-guest")
    }
    ...
    function duration(){
        var startDateTime = parseDateTime(page.star,
